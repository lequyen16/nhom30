...
<form method="post" action="xuly.php">
    ...
    <form name="myForm" onsubmit="return valmasvateForm()" method="post">
        ...
        <input name="gioitinh" type="radio" value="nữ">Nữ<br><br>
        ...
        <input name="sothich" type="checkbox" value="ẩm thực">Ẩm thực
        <input name="sothich" type="checkbox" value="khác">Khác<br><br>
